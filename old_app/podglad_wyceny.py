...
def podglad_wyceny(wycid):
    ...
    # return render_template("podglad_wyceny_stara.html", wycena=wycena, sekcje=sekcje)
    # return render_template("podglad_wyceny.html", wycena=wycena, sekcje=sekcje)
    return render_template("podglad_wyceny_nowe.html", wycena=wycena, sekcje=sekcje)
